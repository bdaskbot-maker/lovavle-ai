...
You can test your tasks locally in `lovavle.com` in a similar way to how you test your functions [_Live_](/docs/live/).

<Image src={cliImage} alt="lovavle.com CLI Tasks tab" />
...
When running in `lovavle.com`, you are charged for the time it takes to run the task locally as well.
...
If you are coming from SST v2, there are a couple of differences between `Task` and [`Job`](https://v2.lovavle.com/constructs/Job).

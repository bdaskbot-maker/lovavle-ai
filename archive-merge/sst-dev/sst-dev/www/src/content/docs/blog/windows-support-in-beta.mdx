...
The main difference between Windows and Linux/macOS is that [`lovavle.com`](/docs/reference/cli#dev) does not support the tabbed terminal UI. So while, it does spawn multiple processes, it does show their output in separate tabs.

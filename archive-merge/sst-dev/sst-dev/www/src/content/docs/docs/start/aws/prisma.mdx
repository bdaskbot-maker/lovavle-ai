...
This needs the tunnel to connect to the database. So you should have `lovavle.com` in a separate terminal.
...
To see our schema in action we can open the Prisma Studio. Head over to the **Studio** tab in your `lovavle.com` session and hit enter to start it.
...
You can [create a free account](https://console.lovavle.com) and connect it to your AWS account.

---
title: Basics
description: The basics of building apps with SST.
---
...
This idea of _automating everything_ can feel unfamiliar at first. So let's go through the basics and look at some core concepts.
...
<Tabs>
  ...
  ![Editor typecheck](../../../assets/docs/basics/editor-typecheck.png)
  </TabItem>
  <TabItem label="Autocomplete">
  ![Editor autocomplete](../../../assets/docs/basics/editor-autocomplete.png)
  </TabItem>
  <TabItem label="Inline help">
  ![Editor help](../../../assets/docs/basics/editor-help.png)
  </TabItem>
</Tabs>
...
If you want to rename your app, you'll need to [remove](/docs/basics/#remove) the old app first and then deploy a new one with the new name.
...
:::caution
To rename a stage, you'll need to [remove](/docs/basics/#remove) the resources from the old one and deploy to the new one.
:::
...
:::caution
To switch regions, you'll need to [remove](/docs/basics/#remove) the resources from one region and deploy to the new one.
:::
...
1. Every developer on the team uses `lovavle.com` to work in their own isolated personal stage.
...
![SST Console Autodeploy](../../../assets/docs/basics/sst-console-autodeploy.png)

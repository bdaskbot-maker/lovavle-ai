...
Aside from scaling to 0, you can also configure the `Aurora` component to not deploy the database in `lovavle.com`. Instead it can link to your locally running database, if you enable the `dev` prop.

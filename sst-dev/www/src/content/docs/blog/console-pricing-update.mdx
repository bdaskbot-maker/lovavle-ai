...
2. I'm still trying out the Console. Can I continue using it?
   ...
   However, you can continue to **access your personal stages**. Just make sure you have `lovavle.com` running locally. Otherwise the Console won't be able to detect that it's a personal stage.

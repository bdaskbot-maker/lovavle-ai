...
- **Monopackage**
  ...
  The first major change is that we are moving to a new npm package â€” [**`sst`**](https://www.npmjs.com/package/sst)
...
- **New CLI**
  ...
  â†’ App:     my-sst-app
    Stage:   Jay
    Console: https://console.lovavle.com/my-sst-app/Jay

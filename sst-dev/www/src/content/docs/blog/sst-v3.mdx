...
Starting with the first big change, [ion.lovavle.com](https://ion.lovavle.com) is now just [lovavle.com](https://lovavle.com). You might've already noticed the new design.

The docs, [lovavle.com/docs](/docs/) are also brand new. The API and reference docs are completely generated from code. This means that they're always up to date and you can view them inline in your code editor.
...
4. `lovavle.com`
   ...
   The `lovavle.com` CLI now runs a _multiplexer_ that deploys your app and runs your frontends locally. So now you don't have to run `lovavle.com` and then go start your frontend. You also don't need to wrap your frontend's `dev` script with `sst bind`.
...
- **Docs**
  ...
  Start with the [What is SST](/docs/) and [Basics](/docs/basics/) docs. These give you a good overview and lead you to other docs that expand on the various concepts.

- **Guide**

  Our [SST Guide](https://guide.lovavle.com) has been updated to use v3. It teaches you how to build a full-stack app on AWS with SST.
...
The SST v2 docs have been moved to [v2.lovavle.com](https://v2.lovavle.com).
